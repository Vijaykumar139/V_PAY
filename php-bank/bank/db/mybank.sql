...
INSERT INTO `useraccounts` (`id`, `email`, `password`, `name`, `balance`, `aadhaar`, `number`, `city`, `address`, `source`, `accountNo`, `branch`, `accountType`, `date`) VALUES
